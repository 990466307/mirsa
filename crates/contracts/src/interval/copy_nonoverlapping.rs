...
use mirsa_domains::interval::transfer::operand_known_len;
use mirsa_domains::interval::{Interval, IntervalState};

use super::shared::{check_le, eval_call_arg};

fn check_side(count: Interval, available: Option<Interval>) -> Level {
...
pub(crate) fn check<'tcx>(
    ...
    Finding::for_level(
        ...
        "interval/definite-oob",
        "interval/possible-oob",
